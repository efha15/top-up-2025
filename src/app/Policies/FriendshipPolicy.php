...
class FriendshipPolicy
{
    ...
    {
        return $user->can('view_any_friendship');
    }
    ...
    {
        return $user->can('view_friendship');
    }
    ...
    {
        return $user->can('create_friendship');
    }
    ...
    {
        return $user->can('update_friendship');
    }
    ...
    {
        return $user->can('delete_friendship');
    }
    ...
    {
        return $user->can('delete_any_friendship');
    }
     ...
     */
    public function replicate(User $user, Friendship $friendship): bool
    {
