...
use App\Filament\Admin\Resources\FriendshipResource\Pages;
use App\Filament\Admin\Resources\FriendshipResource\RelationManagers;
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('user_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('friend_id')
                    ->required()
                    ->numeric(),
            ]);
    }
